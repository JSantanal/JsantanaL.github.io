...
function cambiarIdioma() {
    ...
    if (idioma === "es") {
        ...
        document.getElementById("acerca-descripcion").innerText = "Nací en Madrid, España, y desde joven me interesé por la programación. Estudié Ingeniería Informática en la Universidad de Madrid y he trabajado en varios proyectos relacionados con la tecnología.";
        document.getElementById("acerca-detalle").innerText = "Mi especialidad es el desarrollo web, aunque también tengo experiencia en aplicaciones móviles y software empresarial.";
        document.getElementById("logros-titulo").innerText = "Logros y proyectos";
        document.getElementById("logro1").innerText = "Desarrollé una aplicación de gestión de tareas para empresas.";
        document.getElementById("logro2").innerText = "Fui parte del equipo de desarrollo de una plataforma de comercio electrónico exitosa.";
        document.getElementById("logro3").innerText = "He dado charlas sobre desarrollo web en conferencias internacionales.";
    ...
    // Inglés
        ...
        document.getElementById("acerca-descripcion").innerText = "I was born in Madrid, Spain, and from a young age, I got interested in programming. I studied Computer Engineering at the University of Madrid and have worked on various projects related to technology.";
        document.getElementById("acerca-detalle").innerText = "My specialty is web development, but I also have experience in mobile applications and enterprise software.";
        document.getElementById("logros-titulo").innerText = "Achievements and Projects";
        document.getElementById("logro1").innerText = "I developed a task management application for businesses.";
        document.getElementById("logro2").innerText = "I was part of the development team for a successful e-commerce platform.";
        document.getElementById("logro3").innerText = "I have given talks on web development at international conferences.";
